...
@objc public protocol PasscodeKitDelegate {
    ...
    @objc optional func passcodeEnteredSuccessfully(index: Int)
...
extension PasscodeKit {
    ...
    func presentPasscodeVerify(_ viewController: UIViewController, delegate: PasscodeKitDelegate? = nil, _ index: Int = 0) {
		DispatchQueue.main.async {
			let passcodeKitVerify = PasscodeKitVerify()
            passcodeKitVerify.idx = index
            passcodeKitVerify.delegate = delegate ?? PasscodeKit.delegate
